...
import  tradeImage from '../../../public/images/Trade/security.png';
    ...
    return (
        <div className="mx-auto max-w-7xl mt-48 mb-16 px-6 relative">
            ...
            <div className="grid lg:grid-cols-2 gap-x-7">
                {/* Column-1 */}
                <div>
                    <Image src={tradeImage} alt="macBook-image" className='rounded-3xl ' width={787} height={512} />
                </div>

                {/* Column-2 */}

                <div>
                    <h3 className="text-3xl lg:text-5xl font-semibold text-offwhite mb-6 text-center sm:text-start">Protect Yourself Anywhere <br /> Any time</h3>
